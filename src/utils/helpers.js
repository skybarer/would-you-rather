...
export const getFilteredQuestions = (questions, authedUser, questionVisibilityFilter) =>
    questionVisibilityFilter === QuestionFilters.ANSWERED ? Object.keys(questions).filter(
        qid =>
